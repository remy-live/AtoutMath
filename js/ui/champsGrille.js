...
export const REGLAGE_SAISIE = {
    ...
    papier: false,
    aide: 'Chaque case devient un champ : on tape le chiffre et l\'on passe à la '
        + 'suivante. Décoché, la grille se remplit en touchant une case puis un jeton — '
        + 'plus sûr sur une tablette.',
    default: true
};
