 ...
 */
export function genererTableau({ rng = makeRng(1), palier = 'facile', enonce = null, tour = null } = {}) {
...
/** La case est-elle donnée, ou à trouver ? */
export const estDonnee = (t, r, c) => t.connus.includes(cle(r, c));
