...
const NIVEAUX = [
    {
        ...
        amorce: [av(50)],
        aide: ['Le trait mesure 120 pas de long, soit 12 carreaux.', 'Touche le nombre dans le bloc pour le changer.'],
    ...
    },
    {
        ...
        depart: { dir: 90, stylo: true },
        modele: [av(120), dr(90), av(120)],
        amorce: [av(120), dr(45), av(120)],
    ...
    },
    {
        ...
        // suivant convaincant.
        modele: [av(100), dr(90), av(100), dr(90), av(100), dr(90), av(100), dr(90)],
        amorce: [],
        aide: ['Quatre côtés, donc quatre fois « avancer » et quatre fois « tourner ».',
            'Chaque côté fait 100 pas — 10 carreaux — et chaque tour 90 degrés.'],
    ...
    },
    {
        ...
        modele: [rep(3, [av(40), dr(90), av(40), ga(90)])],
        amorce: [],
        exigences: { boucle: true },
    ...
    },
    {
        ...
        modele: [va(-60, 0), po(), av(120), le(), va(0, -60), ga(90), po(), av(120)],
        amorce: [],
    ...
    },
    {
        ...
        modele: [rep(4, [av(70), dr(90)]), ga(60), av(70), dr(120), av(70)],
        amorce: [],
    ...
    },
    {
        ...
        palette: ['avancer', 'droite', 'repeter'],
        depart: { dir: 90, stylo: true },
        modele: [rep(6, [rep(4, [av(40), dr(90)]), dr(60)])],
        amorce: [],
