...
import { tirerMots, creerGrille, THEMES } from '../motsCaches.js';
    ...
    generate(params, ctx) {
        ...
        return makeItem({
            ...
            prompt: {
                ...
                html: `<div class="game-question">Grille ${taille} × ${taille}</div>`
            },
            answer: liste,
            ...
            meta: {
                taille, vocabulaire: theme, indices,
