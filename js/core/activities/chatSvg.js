// Le chat de Scratch, tel quel.
//
// Repris du plugin fourni : c'est le personnage que les élèves reconnaissent,
// et le redessiner à la main n'apporterait rien. Posé en `data:` pour que rien
// ne parte en réseau — l'application doit fonctionner hors ligne.
//
// Le dessin regarde vers la DROITE, ce qui correspond à la direction 90 de la
// machine virtuelle : la scène n'a donc qu'à tourner de (direction − 90).
export const CHAT_SVG = `data:image/svg+xml;utf8,<svg width="96px" height="101px" viewBox="0 0 96 101" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <g>
...
/** Largeur et hauteur du dessin, pour le mettre à l'échelle sans le déformer. */
export const CHAT_TAILLE = { w: 96, h: 101 };
